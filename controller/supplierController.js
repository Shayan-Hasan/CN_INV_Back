...
const GetVendorIDProductsDetail = (req, res) => {
  console.log(req.body);
  const sql =
    ...
    "u.name as unit_id, c.name as category_id, b.name as brand_id,i.image,v.notes FROM inv.products p left outer join inv.vendor_products v on p.product_id = v.product_id LEFT OUTER JOIN ( SELECT  " +
