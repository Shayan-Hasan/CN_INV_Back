...
router.get("/GetAllProductListSup", productController.GetAllProductListSup);

router.post(
  "/GetOrderProductDetailById",
  productController.GetOrderProductDetailById
);
router.post("/getProductsByFilter", productController.getProductsByFilter);
router.post(
  "/GetAssignedProductDetailById",
  productController.GetAssignedProductDetailById
);
router.post("/DelProduct", productController.DelProduct);
router.post("/CheckProductBeforeDel", productController.CheckProductBeforeDel);
